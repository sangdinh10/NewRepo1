...
namespace ProjectWebAPI.Controllers
{
    ...
    public class UserDetailController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult PostUserDetail(UserDetail userDetailDTO)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult UpdateUserDetail(int id, UserDetail updateUserDetailDTO)
        {
		...
		public async Task<ActionResult<List<UserDetailDTO>>> GetUserDetailsByUserIdsAsync([FromQuery] List<int> userIds)
		{
			try
			{
